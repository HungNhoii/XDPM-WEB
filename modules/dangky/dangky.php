...
if (isset($_POST['dangky'])) {
	...
	if (count($rs)) {
		...
		$rs = $o->query($sql);
		if ($rs)
			echo "<script>alert('Chúc mừng bạn đã là thành viên của hội đa cấp Trần Văn Hưng. Mời bạn đăng nhập theo tài khoản đã đăng ký'); location='?mod=dangnhap';</script>";
	}
}
?>

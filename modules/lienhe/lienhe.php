...
<div id="lienhe">
    ...
    <span class="style">CÔNG TY CỔ PHẦN CÔNG NGHỆ VĂN HƯNG</span>
    <p class="tintuc">

    <p class="tintuc">Địa chỉ:180 Cao Lỗ Phường 4 Quận 8 TPHCM</p>
    <p class="tintuc">Điện thoại:0838173679</p>
    <p class="tintuc">Fax:</p>
    <p class="tintuc">Email:hung@gmail.com</p>
    </p>

...
$tongsobanghi = count($o->query($vSQL_1)->fetchAll());
...
<?php if ($vAct == 'add' || $vAct == 'edit') {
	$vSQL_Edit = "SELECT * FROM products_type";
	$vResult_Edit = $o->query($vSQL_Edit)->fetchAll();
	$vRow_Edit = $vResult_Edit[0];
...
<fieldset>
    ...
    <form method="post" action="" id="mproducts_Form" enctype="multipart/form-data">
        <table border="0" cellspacing="0" cellpadding="5">
            ...
            <tr>
                <td>Tên sản phẩm:</td>
                <td><input type="text" name="txtProductName" id="txtProductName" style="width:250px;"
                        value="<?php echo isset($eProductName) ? $eProductName : ''; ?>" /></td>
            </tr>
            <tr>
                <td>SKU:</td>
                <td><input type="text" name="txtSKU" id="txtSKU" style="width:250px;"
                        value="<?php echo isset($eSKU) ? $eSKU : ''; ?>" /></td>
            </tr>
            <tr>
                <td>Giá:</td>
                <td><input type="text" name="txtPrice" id="txtPrice" style="width:250px;"
                        value="<?php echo isset($ePrice) ? $ePrice : ''; ?>" /></td>
            </tr>
            <tr>
                <td>Hình ảnh:</td>
            ...
            <tr>
                <td>Mô tả:</td>
                <td><textarea name="txtDescription" id="txtDescription" rows="10"
                        cols="65"><?php echo isset($eDescription) ? $eDescription : ''; ?></textarea></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
...
<fieldset>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-result">
        ...
        <tr>
            ...
            <td align="center"><a href="?mod=<?php echo $vModule; ?>&act=edit&id=<?php echo $vRowSel["ID"]; ?>">Sửa</a>
            </td>
            <td align="center"><a href="?mod=<?php echo $vModule; ?>&act=del&id=<?php echo $vRowSel["ID"]; ?>"
